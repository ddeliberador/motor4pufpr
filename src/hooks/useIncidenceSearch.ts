      ...
      institutions: [
        {
          ...
          courses_count: 12,
          relevant_courses: ['Engenharia Elétrica', 'Química', 'Física'],
          grade_enade: 4.2,
        },
        {
          id: 'usp_1',
          ...
          state: 'SP',
          city: 'São Paulo',
          category: 'Pública Estadual',
          type: 'Pública Estadual',
          courses_count: 25,
          relevant_courses: ['Engenharia de Materiais', 'Química', 'Física'],
          grade_enade: 4.8,
        },
      ],
      courses: [],
