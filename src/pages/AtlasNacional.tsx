...
import { 
  ArrowLeft, Search, MapPin, Trophy, Network, Calculator, Building2, 
  Lightbulb, Globe, Users, FileText, Briefcase, ChevronRight, 
  ExternalLink, TrendingUp, Target, Layers, Microscope, Factory,
  Leaf, Cpu, Heart, Atom
} from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="hero-section pt-32 pb-24 md:pt-40 md:pb-32">
        <div className="container-narrow text-center">
          ...
          <p className="text-sm uppercase tracking-widest text-primary-foreground/70 mb-4 animate-fade-in">
            MOTOR 4P UFPR
          </p>
          <h1 className="text-3xl md:text-5xl font-bold text-primary-foreground mb-6 animate-fade-in font-serif">
            Atlas Nacional de Capacidades<br />Científicas e Tecnológicas
          </h1>
          <p className="text-lg md:text-xl text-primary-foreground/90 mb-4 animate-fade-in" style={{ animationDelay: "0.1s" }}>
            Mapa comparativo de universidades e centros de pesquisa do Brasil por objeto tecnológico.
          </p>
          <p className="text-base text-primary-foreground/75 max-w-2xl mx-auto mb-10 animate-fade-in" style={{ animationDelay: "0.2s" }}>
            Dado um tema científico ou tecnológico, o Motor 4P identifica onde estão os principais polos nacionais de pesquisa, inovação e propriedade intelectual.
          </p>
            ...
            <form onSubmit={handleSearch}>
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-4 rounded-xl border-0 bg-primary-foreground text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-accent shadow-lg"
                />
              </div>
              <button
                type="submit"
                disabled={!searchQuery.trim()}
                className="w-full mt-4 bg-accent text-accent-foreground py-3 rounded-xl font-medium hover:bg-accent/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Explorar Atlas Nacional
              </button>
            </form>
            <div className="mt-6">
              <p className="text-xs text-primary-foreground/60 mb-3">Exemplos de pesquisa:</p>
              <div className="flex flex-wrap justify-center gap-2">
                {["Inteligência Artificial Industrial", "Semicondutores", "Baterias de Sódio", "Biomateriais para Saúde"].map((example) => (
                  <button
                    key={example}
                    onClick={() => handleExampleClick(example)}
                    className="px-3 py-1.5 bg-primary-foreground/10 text-primary-foreground rounded-full text-sm hover:bg-primary-foreground/20 transition-colors border border-primary-foreground/20"
                  >
                    {example}
                  </button>
                ))}
          ...
          <Link
            to="/mvp"
            className="inline-flex items-center gap-2 text-primary-foreground/70 hover:text-primary-foreground transition-colors mt-10 animate-fade-in"
            style={{ animationDelay: "0.4s" }}
          >
            <ArrowLeft className="w-4 h-4" />
            Voltar para MVP Engine
          </Link>
        </div>
      </section>
      ...
      <section className="section-spacing">
        <div className="container-wide">
          ...
          <p className="text-muted-foreground mb-8 max-w-3xl">
            O Motor 4P utiliza bases públicas para mapear universidades e centros de pesquisa ativos em determinado objeto tecnológico.
          </p>
      ...
      <section className="section-spacing">
        <div className="container-wide">
          ...
          <p className="text-muted-foreground mb-8 max-w-3xl">
            O Motor 4P identifica polos nacionais de especialização, revelando redes entre universidades e centros estratégicos.
          </p>
        ...
        <div className="container-narrow">
          ...
          <div className="bg-card border border-border rounded-2xl p-8 mb-8">
            <div className="text-center mb-6">
              ...
              <h3 className="text-2xl font-bold text-foreground font-serif mt-2">ICT-Obj</h3>
            </div>
      ...
      <section className="section-spacing">
        <div className="container-wide">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
            {strategicCenters.map((center, index) => (
              <div 
                key={center.name}
        ...
        <div className="container-narrow">
          <div className="bg-primary rounded-2xl p-10 text-center">
            <h3 className="text-2xl font-bold text-primary-foreground mb-4 font-serif">
              Explore o Atlas Nacional
            </h3>
            <p className="text-primary-foreground/80 mb-6 max-w-xl mx-auto">
              Descubra as capacidades científicas e tecnológicas do Brasil por objeto de pesquisa.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                to="/mvp"
                className="inline-flex items-center justify-center gap-2 bg-primary-foreground text-primary px-6 py-3 rounded-xl font-medium hover:bg-primary-foreground/90 transition-colors"
              >
                Acessar MVP Engine
              ...
              <Link
                to="/"
                className="inline-flex items-center justify-center gap-2 bg-primary-foreground/10 text-primary-foreground px-6 py-3 rounded-xl font-medium hover:bg-primary-foreground/20 transition-colors border border-primary-foreground/20"
              >
                Sobre a Camada Ausente
              </Link>
            </div>
          </div>
        </div>
